...
import HistoryDetails from './Component/History'
...
class App extends Component {
  ...
  render() {
    ...
    const isEmpty = searchInput !== '' && filteredHistory.length === 0
    const isEmptyHistory = historyList.length === 0
    ...
    return (
      <div>
        ...
        <ul>
          ...
          {isEmptyHistory && !isEmpty && <p>Empty History View</p>}
        </ul>
      </div>
    )
  }
